...
<h2 align="center">ASTLE JOE A S</h2>
<h3 align="center">212224240019</h3>
<meta name='viewport' content='width=device-width, initial-scale=1'>
<style type="text/css">
body {
    background-color: rgb(199, 132, 9);
}
.edge {
...
.box {
    border: Thick dashed rgb(47, 37, 24);
    width: 500px;
    min-height: 300px;
    font-size: 20px;
...
![alt text](<Screenshot 2025-04-30 175156.png>)

## HOMEPAGE:
![alt text](<Screenshot 2025-04-30 174844.png>)
